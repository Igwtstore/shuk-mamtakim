...
# vercel.json), reconstruye el contenedor. Un cambio de HTML se ve al instante (el repo está
# montado adentro del contenedor). Escribe una línea por actualización.
set -euo pipefail
