...
(async () => {
  ...
  const cobro = await pg4.evaluate(() => { const ve = () => { const e = document.getElementById('cobro-envio-gratis'); return !e.hidden && getComputedStyle(e).display !== 'none' && e.offsetHeight > 0; }; abrirConfirmarCobro('v1', 150000, 0, 0, 'Cliente 101', 0); const g = ve(); cerrarModalCobro(); abrirConfirmarCobro('v2', 80000, 0, 0, 'Cliente 102', 0); const g2 = ve(); cerrarModalCobro(); return [g, g2]; });
