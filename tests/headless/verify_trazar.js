...
(async () => {
  ...
  const r = await page.evaluate(async () => {
    ...
    vistaSocio = 'todo';
    const V = [
      { id: 'P11', nVenta: 11, cliente: 'Carla Inventada', fecha: '11/06/2026 13:04', estado: 'entregado', stockUpdates: '57:3', productos: '' },
      { id: 'P12', nVenta: 12, cliente: 'Beto Inventado', fecha: '11/06/2026 13:11', estado: 'entregado', stockUpdates: '57:1', productos: '' },
      { id: 'P27', nVenta: 27, cliente: 'Ana Inventada', fecha: '24/06/2026 07:05', estado: 'entregado', stockUpdates: '57:1', productos: '' },
    ];
    const MOVS = [
      { fecha: '22/06/2026 14:55', cambio: 6, antes: 0, despues: 6, origen: 'Ajuste manual (pestaña Stock)' },
      { fecha: '24/06/2026 07:05', cambio: -1, antes: 6, despues: 5, origen: 'Venta #27 — Ana Inventada' },
    ];
  ...
  chk('el aviso detalla quiénes (Carla 3 u. y Beto 1 u. = 4 u.)', /2 compras \(4 u\.\)/.test(r.movs) && /Carla Inventada 3 u/.test(r.movs) && /Beto Inventado 1 u/.test(r.movs));
