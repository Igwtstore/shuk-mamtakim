...
const tienda = new Function(
  ...
  ['esPesos', 'ofertaActiva', 'packActivo', 'ofertaVigente', 'precioEfectivo', '_fechaOfertaISO', '_usaLista', '_lrFila', '_listaRapidaHtml', 'lrPoner', 'lrCambiar'].map(n => fnDe(HTML, n)).join('\n') +
